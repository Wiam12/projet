        ...
        {isCategoryCreated ? (
          ...
          <div className="form-group">
            ...
            >
              ...
              <option value="AC80% - PAC20%">AC80% - PAC20%</option>
              <option value="ACPAC100%">ACPAC100%</option>
            </select>
          </div>
        )}
